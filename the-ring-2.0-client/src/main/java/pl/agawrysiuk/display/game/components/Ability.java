...
//                .getSubimage(0,0,480,480), Scalr.Method.ULTRA_QUALITY, Scalr.Mode.FIT_TO_WIDTH, 250, 0, Scalr.OP_ANTIALIAS);
        ...
        textOnImg.setFont(Font.font(Font.getDefault().getName(), FontWeight.BOLD, 90*StartWindowController.X_WINDOW));
        textOnImg.setEffect(new DropShadow(BlurType.GAUSSIAN, Color.rgb(1, 1, 1, 1), 4, 0.9, 0, 0));
        textOnImg.relocate(0,180*StartWindowController.X_WINDOW);
        pane.getChildren().add(textOnImg);

        Text textDescription = new Text(this.description);
        textDescription.setWrappingWidth(480*StartWindowController.X_WINDOW);
        textDescription.prefWidth(480*StartWindowController.X_WINDOW);
        textDescription.setTextAlignment(TextAlignment.CENTER);
        textDescription.setFill(Color.WHITE);
        textDescription.setViewOrder(-1);
        textDescription.setFont(Font.font(Font.getDefault().getName(), FontWeight.BOLD, 30*StartWindowController.X_WINDOW));
        textDescription.setEffect(new DropShadow(BlurType.GAUSSIAN, Color.rgb(1, 1, 1, 1), 4, 0.9, 0, 0));
        textDescription.relocate(0,300*StartWindowController.X_WINDOW);
        ...
        this.abilityImg = SwingFXUtils.toFXImage(Scalr.resize(SwingFXUtils.fromFXImage(snapshot,null),
                Scalr.Method.ULTRA_QUALITY, Scalr.Mode.FIT_TO_WIDTH, (int) (250*StartWindowController.X_WINDOW), 0, Scalr.OP_ANTIALIAS),null);
